...
## FredonBytes Migration

- Existing app integration playbook: `docs/integration/nextjs-existing-app.md`
- Storefront actions are currently routed through `src/lib/fredonbytes/container.ts` to keep mode selection centralized.
